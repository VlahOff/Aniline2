  ...
  return (
    <div className={classes['table-container']}>
      <table className={classes.table}>
        <thead>
          <tr>
            <th className={`${classes['sticky-col']} ${classes['first-col']}`}>#</th>
            <th className={`${classes['sticky-col']} ${classes['second-col']}`}></th>
            <th className={`${classes['sticky-col']} ${classes['third-col']}`}>Coin</th>
          ...
          {coinData.map((coin, index) => {
            return (
              ...
              >
                ...
                <td className={`${classes['sticky-col']} ${classes['second-col']}`}>
                  <img src={coin.image} alt={`${coin.symbol} logo`} />
                </td>
                <td className={`${classes['sticky-col']} ${classes['third-col']}`}>
                  <p>{coin.name}</p>
                </td>
